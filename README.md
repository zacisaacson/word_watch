...
Please tag Amy and Cory in your final PR by 3:30pm to show us your 🔥awesome🔥 apps. We will comment with feedback! By that time, please have your project deployed to GitHub pages. Also, if you did run the API locally and were hitting that, please change the URL to the Heroku endpoints so it's easier for instructors to check real quick. 
